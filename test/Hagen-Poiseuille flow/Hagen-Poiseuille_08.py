...
def graph():
    ...
    os.chdir(str(value[1]))
    #速度ベクトル作成
    plt.quiver(X_out[1:n, 1:ms], Y_out[1:n, 1:ms], u_out[1:n, 1:ms], v_out[1:n, 1:ms], angles='xy', scale_units='xy', scale=np.max(velocity_out)*(0.5/(L*0.03/2)), width=0.002, headwidth=7, headlength=10, headaxislength=5)
